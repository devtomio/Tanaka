module.exports = class Event {
	 ...
	 * @param {keyof import('discord.js-commando').CommandoClientEvents|keyof import('quickmongo').Events|keyof import('@duxcore/interactive-discord/src/util/types/events').Events} name
